...
@section('subhead')
<title>Dashboard - SIB - Tailwind HTML Admin Template</title>
@endsection
        ...
        <div class="grid grid-cols-12 gap-6">
                ...
                <div class="mt-5 intro-y">
                    <div class="grid grid-cols-12 box">
                        <div class="flex flex-col justify-center col-span-12 px-8 py-12 lg:col-span-4">
                            ...
                            <div class="flex items-center justify-start mt-4">
                                ...
                                <a class="ml-4 text-slate-500" href="">
                                    <x-base.lucide class="w-4 h-4" icon="RefreshCcw" />
                                </a>
                            </div>
                        ...
                        <div class="col-span-12 p-8 border-t border-dashed border-slate-200 dark:border-darkmode-300 lg:col-span-8 lg:border-t-0 lg:border-l">
                            <x-base.tab.group>
                                <x-base.tab.list class="p-1 mx-auto mb-8 border border-dashed rounded-md w-60 border-slate-300 dark:border-darkmode-300" role="tablist" variant="pills">
                                    <x-base.tab id="weekly-report-tab" selected>
                                        <x-base.tab.button class="w-full py-1.5 px-2" as="button">
                                            Weekly
                                        </x-base.tab.button>
                                    </x-base.tab>
                                    ...
                                    <x-base.tab.panel class="grid grid-cols-12 gap-y-8 gap-x-10" id="weekly-report" selected>
                                        <div class="col-span-6 sm:col-span-6 md:col-span-4">
                                            ...
                                            <div class="mt-1.5 flex items-center">
                                                ...
                                                <x-base.tippy class="flex ml-2 text-xs font-medium cursor-pointer text-danger" content="2% Lower than last month">
                                                    2%
                                        ...
                                        <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                            ...
                                            <div class="mt-1.5 flex items-center">
                                                ...
                                                <x-base.tippy class="flex ml-2 text-xs font-medium cursor-pointer text-success" content="52% Higher than last month">
                                                    52%
                                        ...
                                        <div class="col-span-12 sm:col-span-6 md:col-span-4">
                                            ...
                                            <div class="mt-1.5 flex items-center">
                                                <div class="text-base">$72.000</div>
                                                <x-base.tippy class="flex ml-2 text-xs font-medium cursor-pointer text-success" content="49% Higher than last month">
                                                    49%
                                                    <x-base.lucide class="ml-0.5 h-4 w-4" icon="ChevronUp" />
                                                </x-base.tippy>
                                            </div>
            ...
            <div class="col-span-12 mt-6 xl:col-span-8">
                <div class="items-center block h-10 intro-y sm:flex">
                    ...
                    <div class="relative mt-3 text-slate-500 sm:ml-auto sm:mt-0">
                        <x-base.lucide class="absolute inset-y-0 left-0 z-10 w-4 h-4 my-auto ml-3" icon="MapPin" />
            ...
            <div class="col-span-12 mt-6 lg:col-span-8 xl:col-span-4">
                ...
                <div class="mt-5">
                    ...
                    @endforeach
                    <a class="block w-full py-4 text-center border border-dotted rounded-md intro-y border-slate-400 text-slate-500 dark:border-darkmode-300" href="">
                        View More
                    </a>
                </div>
            </div>
            ...
            <div class="col-span-12 mt-6 md:col-span-6 lg:col-span-4">
                ...
                <div class="p-5 mt-12 intro-y box sm:mt-5">
                    <div class="flex pb-3 mb-3 border-b border-dashed border-slate-200 text-slate-500 dark:border-darkmode-300">
                        <div>Parameters</div>
                    ...
                    <div class="flex items-center mb-5">
                        <div class="flex items-center">
                            <div>Site Visits</div>
                            <x-base.tippy class="flex ml-2 text-xs font-medium cursor-pointer text-danger" content="49% Higher than last month">
                                -2%
                                <x-base.lucide class="ml-0.5 h-4 w-4" icon="ChevronDown" />
                            </x-base.tippy>
                        </div>
                    ...
                    <x-base.button class="relative justify-start w-full mb-2 border-dashed border-slate-300 dark:border-darkmode-300" variant="outline-secondary">
                ...
                <div class="items-center block h-10 intro-y sm:flex">
                    ...
                    <div class="flex items-center mt-3 sm:ml-auto sm:mt-0">
                        <x-base.button class="!box flex items-center text-slate-600 dark:text-slate-300">
                            <x-base.lucide class="hidden w-4 h-4 mr-2 sm:block" icon="FileText" />
                            Export to Excel
                        </x-base.button>
                    ...
                    <x-base.table class="border-separate border-spacing-y-[10px] sm:mt-2">
                        ...
                        <x-base.table.tbody>
                            ...
                            <x-base.table.tr class="intro-x">
                                <x-base.table.td class="w-40 border-b-0 bg-white shadow-[20px_3px_20px_#0000000b] first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600">
                                    <div class="flex">
                                        <div class="w-10 h-10 image-fit zoom-in">
                                            <x-base.tippy class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="{{ Vite::asset($faker['images'][0]) }}" alt="Midone Tailwind HTML Admin Template" as="img" content="{{ 'Uploaded at ' . $faker['dates'][0] }}" />
                                        </div>
                                        <div class="w-10 h-10 -ml-5 image-fit zoom-in">
                                            <x-base.tippy class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="{{ Vite::asset($faker['photos'][1]) }}" alt="Midone Tailwind HTML Admin Template" as="img" content="{{ 'Uploaded at ' . $faker['dates'][1] }}" />
                                        </div>
                                        <div class="w-10 h-10 -ml-5 image-fit zoom-in">
                                            <x-base.tippy class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="{{ Vite::asset($faker['photos'][2]) }}" alt="Midone Tailwind HTML Admin Template" as="img" content="{{ 'Uploaded at ' . $faker['dates'][2] }}" />
                                        </div>
                                    </div>
                                </x-base.table.td>
                                ...
                                <x-base.table.td class="w-40 border-b-0 bg-white shadow-[20px_3px_20px_#0000000b] first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600">
                                    <div @class([ 'flex items-center justify-center' , 'text-success'=> $faker['true_false'][0],
                                ...
                                <x-base.table.td class="relative w-56 border-b-0 bg-white py-0 shadow-[20px_3px_20px_#0000000b] before:absolute before:inset-y-0 before:left-0 before:my-auto before:block before:h-8 before:w-px before:bg-slate-200 first:rounded-l-md last:rounded-r-md dark:bg-darkmode-600 before:dark:bg-darkmode-400">
                                    <div class="flex items-center justify-center">
                                        <a class="flex items-center mr-3" href="">
                                            <x-base.lucide class="w-4 h-4 mr-1" icon="CheckSquare" />
                                            Edit
                                        </a>
                                        <a class="flex items-center text-danger" href="">
                                            <x-base.lucide class="w-4 h-4 mr-1" icon="Trash" />
                                            Delete
                                        </a>
                                    </div>
                                </x-base.table.td>
                ...
                <div class="flex flex-wrap items-center mt-3 intro-y sm:flex-row sm:flex-nowrap">
                    <x-base.pagination class="w-full sm:mr-auto sm:w-auto">
                        <x-base.pagination.link>
                            <x-base.lucide class="w-4 h-4" icon="ChevronsLeft" />
                        </x-base.pagination.link>
                        <x-base.pagination.link>
                        ...
                        <x-base.pagination.link>
                            <x-base.lucide class="w-4 h-4" icon="ChevronsRight" />
                        </x-base.pagination.link>
                    </x-base.pagination>
            ...
            <div class="grid grid-cols-12 gap-x-6 gap-y-6 2xl:gap-x-0 2xl:pl-6">
                ...
                <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-12 2xl:mt-8">
                    <div class="flex items-center h-10 intro-x">
                        ...
                        <x-base.button class="px-2 mr-2 tiny-slider-navigator border-slate-300 text-slate-600 dark:text-slate-300" data-carousel="important-notes" data-target="prev">
                            <x-base.lucide class="w-4 h-4" icon="ChevronLeft" />
                        </x-base.button>
                        <x-base.button class="px-2 mr-2 tiny-slider-navigator border-slate-300 text-slate-600 dark:text-slate-300" data-carousel="important-notes" data-target="next">
                            <x-base.lucide class="w-4 h-4" icon="ChevronRight" />
                        </x-base.button>
                    </div>
                            ...
                            <x-base.tiny-slider id="important-notes">
                                <div class="p-5">
                                    ...
                                    <div class="flex mt-5 font-medium">
                                        ...
                                        <x-base.button class="px-2 py-1 ml-auto" type="button" variant="outline-secondary">
                                            Dismiss
                                        </x-base.button>
                                    </div>
                                </div>
                ...
                <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-4 2xl:col-span-12">
                    ...
                    <div class="relative mt-5 before:absolute before:ml-5 before:mt-5 before:block before:h-[85%] before:w-px before:bg-slate-200 before:dark:bg-darkmode-400">
                        <div class="relative flex items-center mb-3 intro-x">
                            <div class="before:absolute before:mt-5 before:ml-5 before:block before:h-px before:w-20 before:bg-slate-200 before:dark:bg-darkmode-400">
                                <div class="flex-none w-10 h-10 overflow-hidden rounded-full image-fit">
                                    <img src="{{ Vite::asset($fakers[9]['photos'][0]) }}" alt="Midone Tailwind HTML Admin Template" />
                                </div>
                            </div>
                        ...
                        <div class="relative flex items-center mb-3 intro-x">
                            <div class="before:absolute before:mt-5 before:ml-5 before:block before:h-px before:w-20 before:bg-slate-200 before:dark:bg-darkmode-400">
                                <div class="flex-none w-10 h-10 overflow-hidden rounded-full image-fit">
                                    <img src="{{ Vite::asset($fakers[8]['photos'][0]) }}" alt="Midone Tailwind HTML Admin Template" />
                                </div>
                            </div>
                            <div class="flex-1 px-5 py-3 ml-4 box zoom-in">
                                <div class="flex items-center">
                                ...
                                <div class="text-slate-500">
                                    ...
                                    <div class="flex mt-2">
                                        <x-base.tippy class="w-8 h-8 mr-1 image-fit zoom-in" as="div" content="{{ $fakers[0]['products'][0]['name'] }}">
                                            <img class="border border-white rounded-md" src="{{ Vite::asset($fakers[8]['photos'][0]) }}" alt="Midone Tailwind HTML Admin Template" />
                                        </x-base.tippy>
                                        <x-base.tippy class="w-8 h-8 mr-1 image-fit zoom-in" as="div" content="{{ $fakers[1]['products'][0]['name'] }}">
                                            <img class="border border-white rounded-md" src="{{ Vite::asset($fakers[8]['photos'][1]) }}" alt="Midone Tailwind HTML Admin Template" />
                                        </x-base.tippy>
                                        <x-base.tippy class="w-8 h-8 mr-1 image-fit zoom-in" as="div" content="{{ $fakers[2]['products'][0]['name'] }}">
                                            <img class="border border-white rounded-md" src="{{ Vite::asset($fakers[8]['photos'][2]) }}" alt="Midone Tailwind HTML Admin Template" />
                                        </x-base.tippy>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="relative flex items-center mb-3 intro-x">
                            <div class="before:absolute before:mt-5 before:ml-5 before:block before:h-px before:w-20 before:bg-slate-200 before:dark:bg-darkmode-400">
                                <div class="flex-none w-10 h-10 overflow-hidden rounded-full image-fit">
                                    <img src="{{ Vite::asset($fakers[7]['photos'][0]) }}" alt="Midone Tailwind HTML Admin Template" />
                                </div>
                            </div>
                            <div class="flex-1 px-5 py-3 ml-4 box zoom-in">
                                <div class="flex items-center">
                        ...
                        <div class="relative flex items-center mb-3 intro-x">
                            <div class="before:absolute before:mt-5 before:ml-5 before:block before:h-px before:w-20 before:bg-slate-200 before:dark:bg-darkmode-400">
                                <div class="flex-none w-10 h-10 overflow-hidden rounded-full image-fit">
                                    <img src="{{ Vite::asset($fakers[6]['photos'][0]) }}" alt="Midone Tailwind HTML Admin Template" />
                                </div>
                            </div>
                            <div class="flex-1 px-5 py-3 ml-4 box zoom-in">
                                <div class="flex items-center">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="intro-x">
                            <div class="flex items-center px-5 py-3 mb-3 box zoom-in">
                                ...
                                <div @class([ 'text-success'=> $faker['true_false'][0],
                                    'text-danger' => !$faker['true_false'][0],
                                    ])>
                        ...
                        @endforeach
                        <a class="block w-full py-3 text-center border border-dotted rounded-md intro-x border-slate-400 text-slate-500 dark:border-darkmode-300" href="">
                            View More
                        </a>
                    </div>
                </div>
                ...
                <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-4 xl:col-start-1 xl:row-start-2 2xl:col-span-12 2xl:col-start-auto 2xl:row-start-auto">
                    <div class="flex items-center h-10 intro-x">
                        ...
                        <a class="flex items-center ml-auto truncate text-primary" href="">
                            <x-base.lucide class="w-4 h-4 mr-1" icon="Plus" /> Add New Schedules
                        </a>
                    </div>
                    <div class="mt-5">
                        <div class="intro-x box">
                            <div class="p-5">
                                <div class="flex">
                                    <x-base.lucide class="w-5 h-5 text-slate-500" icon="ChevronLeft" />
                                    <div class="mx-auto text-base font-medium">April</div>
                                    <x-base.lucide class="w-5 h-5 text-slate-500" icon="ChevronRight" />
                                </div>
