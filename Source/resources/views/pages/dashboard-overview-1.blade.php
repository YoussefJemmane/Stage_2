        ...
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="grid grid-cols-12 col-span-12 gap-6 mt-8">
                    <div class="col-span-12 intro-y sm:col-span-6 2xl:col-span-3">
                    ...
                    <div class="col-span-12 intro-y sm:col-span-6 2xl:col-span-3">
                        <div class="p-5 box zoom-in">
                            <div class="flex">
                                ...
                                <div
                                    class="flex items-center px-2 py-1 ml-auto text-xs truncate rounded-full cursor-pointer bg-slate-100 text-slate-500 dark:bg-darkmode-400">
                                    320 Followers
                                </div>
                            </div>
                            <div class="mt-1">
